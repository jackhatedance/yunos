...
import net.abstractfactory.yunos.dao.TokenDao;
...
import net.abstractfactory.yunos.domain.auth.TokenDeviceAuthorization;
import net.abstractfactory.yunos.domain.auth.TokenUserAuthorization;
