...
import net.abstractfactory.yunos.domain.ConfigurationItem;
...
import net.abstractfactory.yunos.service.DeviceClassService;
import net.abstractfactory.yunos.service.DeviceService;
...
public class ServiceTest {
	...
	public void testDriverService() throws Exception {
		...
		Assert.assertEquals(
				"net.abstractfactory.yunos.deviceApi.transmitter.MySwitch",
				actualTypeParameter);
