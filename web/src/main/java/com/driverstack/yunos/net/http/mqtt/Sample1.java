...
public class Sample1 implements MqttCallback {
	...
	public static void main(String[] args) {
		...
		String message = "isOn";
		int qos = 2;
		String broker = "10.224.202.59";
		int port = 1883;
		String clientId = null;
		String subTopic = "/response/from/device/123";
		String pubTopic = "/request/to/device/123";
		...
		try {
			...
			Sample1 sampleClient = new Sample1(url, clientId, cleanSession,
	 ...
	 */
	public Sample1(String brokerUrl, String clientId, boolean cleanSession,
