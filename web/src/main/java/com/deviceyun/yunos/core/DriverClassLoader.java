...
public class DriverClassLoader {
	...
	public com.deviceyun.yunos.driver.Driver loadDriver(
			com.deviceyun.yunos.domain.Driver driver) {
		...
		return (com.deviceyun.yunos.driver.Driver) factory.create(jcl,
				driver.getClassName());
	}
	 ...
	 * @return
	 */
	public com.deviceyun.yunos.driver.Driver loadDriver(InputStream input,
			String className) {
