...
public class ConfigureAnnotationParser {
	...
	public net.abstractfactory.yunos.driver.config.ConfigurationDefinition parse(
			Class configClass) {
		...
		ConfigurationDefinition configureDef = new net.abstractfactory.yunos.driver.config.ConfigurationDefinition(
